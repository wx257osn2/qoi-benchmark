...
update-alternatives --install /usr/local/bin/cc       cc       /usr/bin/clang-${LLVM_VERSION} ${LLVM_VERSION}
update-alternatives --install /usr/local/bin/c++      c++      /usr/bin/clang++-${LLVM_VERSION} ${LLVM_VERSION}
